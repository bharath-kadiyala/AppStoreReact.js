...
class AppStore extends Component {
  ...
  getAppsList = () => {
    ...
    const filterApps = appsList.filter(
      eachAppList => eachAppList.category === activeTabId,
    )
    const filteredAppsList = filterApps.filter(eachApp =>
  ...
  render() {
    ...
    const listOfApps = this.getAppsList()
    ...
    return (
      <div className="bg-main-con">
        <div className="card-con">
          ...
          <ul className="tabItems-con">
            {tabsList.map(eachTab => (
              <TabItem
                tabItems={eachTab}
                key={eachTab.tabId}
                specificTab={this.getSpecificTab}
          ...
          <ul className="appItem-con">
            {listOfApps.map(eachList => (
              <AppItem tabsLists={eachList} key={eachList.appId} />
            ))}
          </ul>
        </div>
      </div>
